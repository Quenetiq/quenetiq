...
@Component({
  ...
  standalone: true,
  template: `
    <h1>@quenetiq/debugging</h1>
    <p>Request inspector and DevTools panel for GraphQL debugging.</p>
    @if (notes().length) {
      <ul>
      ...
      <p><em>Open DevTools panel to inspect GraphQL request lifecycle.</em></p>
    }
  `,
})
