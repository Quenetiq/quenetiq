...
import { mapGlobalConfigToClientConfig, mapGlobalConfigToCacheConfig } from '../quenetiq-config-provider';
import type { QuenetiqGlobalConfig } from '../quenetiq-config-provider';

describe('QuenetiqConfigProvider — config mapping', () => {
	beforeEach(() => {
		vi.clearAllMocks();
	});
